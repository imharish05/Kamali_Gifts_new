...
const STATUS_EMAIL_CONFIG = {
  confirmed: {
    subject: (orderId) => `Order Confirmed 🎉 — Order #${orderId} | Kamali Gifts Factory`,
    heroIcon: "🎉",
  ...
  shipped: {
    subject: (orderId) => `Order Shipped 📦 — Order #${orderId} | Kamali Gifts Factory`,
    heroIcon: "📦",
  ...
  processing: {
    subject: (orderId) => `Out For Delivery 🚚 — Order #${orderId} | Kamali Gifts Factory`,
    heroIcon: "🚚",
  ...
  delivered: {
    subject: (orderId) => `Delivered Successfully ✅ — Order #${orderId} | Kamali Gifts Factory`,
    heroIcon: "✅",
  ...
  cancelled: {
    subject: (orderId) => `Order Cancelled ❌ — Order #${orderId} | Kamali Gifts Factory`,
    heroIcon: "❌",
  ...
  returned: {
    subject: (orderId) => `Return Request Updated ↩️ — Order #${orderId} | Kamali Gifts Factory`,
    heroIcon: "↩️",
  ...
  admin_new_order: {
    subject: (orderId) => `New Order Received 🛍️ — Order #${orderId} | Kamali Gifts Factory`,
    heroIcon: "🛍️",
    heroTitle: "New Order Received",
    heroMessage: "A new order has been placed on Kamali Gifts Factory. Below are the order details.",
    badgeText: "New Order",
    badgeStyle: BADGE_STYLES.green,
...
const RETURN_EMAIL_CONFIG = {
  return_submitted: {
    subject: (id) => `Return Request Submitted 📦 — Return #${id} | Kamali Gifts Factory`,
    heroIcon: "📦",
  ...
  approved: {
    subject: (id) => `Return Request Approved ✅ — Return #${id} | Kamali Gifts Factory`,
    heroIcon: "✅",
  ...
  rejected: {
    subject: (id) => `Return Request Rejected ❌ — Return #${id} | Kamali Gifts Factory`,
    heroIcon: "❌",
  ...
  pickup_scheduled: {
    subject: (id) => `Reverse Pickup Scheduled 🚚 — Return #${id} | Kamali Gifts Factory`,
    heroIcon: "🚚",
  ...
  picked_up: {
    subject: (id) => `Item Picked Up 📬 — Return #${id} | Kamali Gifts Factory`,
    heroIcon: "📬",
  ...
  inspection_completed: {
    subject: (id) => `Inspection Completed 🔍 — Return #${id} | Kamali Gifts Factory`,
    heroIcon: "🔍",
  ...
  refund_initiated: {
    subject: (id) => `Refund Initiated 💰 — Return #${id} | Kamali Gifts Factory`,
    heroIcon: "💰",
  ...
  refund_completed: {
    subject: (id) => `Refund Completed ✅ — Return #${id} | Kamali Gifts Factory`,
    heroIcon: "✅",
  ...
  replacement_shipped: {
    subject: (id) => `Replacement Shipped 📦 — Return #${id} | Kamali Gifts Factory`,
    heroIcon: "📦",
  ...
  replacement_delivered: {
    subject: (id) => `Replacement Delivered ✅ — Return #${id} | Kamali Gifts Factory`,
    heroIcon: "✅",
...
<table width="600" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
  ...
  <tr>
    <td style="background:linear-gradient(135deg,rgba(223,77,129,0.4) 0%,rgb(255,232,214) 100%);padding:36px 40px;text-align:center;">
      <h1 style="margin:0;color:#000;font-size:26px;font-weight:700;letter-spacing:0.5px;">🎁 Kamali Gifts Factory</h1>
  ...
  <tr>
    <td style="padding:24px 40px;background:#fafafa;text-align:center;border-top:1px solid #f0f0f0;">
      ...
      <p style="margin:0;font-size:12px;color:#bbb;">© ${new Date().getFullYear()} Kamali Gifts Factory. All rights reserved.</p>
    </td>
  </tr>
...
const sendOrderStatusEmail = async ({ order, user, status, trackingDetails } = {}) => {
  ...
  await transporter.sendMail({
    from: `"Kamali Gifts Factory" <${process.env.EMAIL_USER}>`,
    to: user.email,
...
const sendAdminNewOrderEmail = async (order, user) => {
  ...
  const displayId = getDisplayReference(orderData, orderData.id);
  await transporter.sendMail({
    from: `"Kamali Gifts Factory Alert" <${process.env.EMAIL_USER}>`,
    to: adminEmail,
    subject: config.subject(displayId),
    html,
  });
      ...
      <tr>
        <td style="padding:0 40px 28px;">
          <div style="background:#eff6ff;border:1px solid #bfdbfe;border-radius:10px;padding:16px;">
            ...
            <p style="margin:0;font-size:13px;color:#666;">Delivery Charge: <strong>Paid by Kamali Gifts Factory (Prepaid)</strong></p>
            ${buttonHtml}
          </div>
        </td>
      </tr>`;
