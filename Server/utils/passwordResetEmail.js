...
<head>
  ...
  <title>Reset Your Password – Kamali Gifts Factory</title>
</head>
    ...
    <table width="580" cellpadding="0" cellspacing="0"
      ...
      <tr>
        <td style="background:linear-gradient(135deg,rgba(219,26,93,0.15) 0%,rgb(255,232,214) 100%);padding:36px 40px;text-align:center;">
          <h1 style="margin:0;color:#db1a5d;font-size:26px;font-weight:700;letter-spacing:0.5px;">🎁 Kamali Gifts Factory</h1>
      ...
      <tr>
        <td style="padding:36px 40px 24px;text-align:center;">
          ...
          <p style="margin:0;color:#666;font-size:15px;line-height:1.6;">
            We received a request to reset your Kamali Gifts Factory account password.<br/>
            ...
            <tr>
              <td style="padding:10px 14px;">
                <p style="margin:0;font-size:13px;color:#92400e;line-height:1.6;">
                  ...
                  Never share this OTP with anyone — Kamali Gifts Factory will never ask for it.
                </p>
              </td>
            </tr>
          </table>
      ...
      <tr>
        <td style="padding:24px 40px;background:#fafafa;text-align:center;border-top:1px solid #f0f0f0;">
          ...
          <p style="margin:0;font-size:12px;color:#bbb;">© ${year} Kamali Gifts Factory. All rights reserved.</p>
        </td>
      </tr>
