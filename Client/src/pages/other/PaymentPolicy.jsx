...
const PaymentPolicy = () => {
  ...
  return (
    <Fragment>
      <SEO
        titleTemplate="Payment Policy – Kamali Gifts Factory"
        description="Kamali Gifts Factory payment policy — learn about accepted payment methods, Razorpay security, COD, EMI options, refund timelines, and how we handle failed transactions."
      />
          ...
          <div className="policy-body">
            ...
            <div style={{ marginBottom: 40 }}>
              <p style={{ fontSize: 15, lineHeight: 1.85, color: "#444" }}>
                At <strong style={{ color: "#0d1b40" }}>Kamali Gifts Factory</strong>, all payments are processed securely through <strong>Razorpay</strong> — one of India's leading PCI-DSS Level 1 certified payment gateways. This policy explains how we collect payments, what methods we accept, how refunds work, and how we protect your financial data. We do not store any card, UPI, or banking credentials on our servers.
              </p>
              ...
              <div className="policy-highlight" style={{ display: "flex", alignItems: "flex-start", gap: 14 }}>
                ...
                <div>
                  ...
                  <p style={{ margin: "4px 0 0", fontSize: 13, color: "#666" }}>
                    Razorpay is a PCI-DSS Level 1 certified payment gateway compliant with RBI guidelines. Your card details, UPI credentials, and net banking information are handled entirely within Razorpay's encrypted infrastructure — Kamali Gifts Factory never receives or stores this data.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="policy-section" id="pay-2">
              ...
              <p>
                When you click "Proceed to Pay" at checkout, you are redirected to Razorpay's secure hosted payment page. The entire payment interaction — entering card details, UPI PIN, or net banking credentials — occurs within <strong>Razorpay's PCI-DSS compliant environment</strong>, not on Kamali Gifts Factory' servers.
              </p>
              <ul className="policy-ul">
                ...
                <li>Card data is tokenized by Razorpay; Kamali Gifts Factory only receives a token and transaction reference ID</li>
                ...
                <li>Payment confirmation is communicated to Kamali Gifts Factory via Razorpay's secure webhook; your order enters production only after payment is fully authorized</li>
            ...
            <div className="policy-section" id="pay-3">
              ...
              <p>
                Kamali Gifts Factory offers a <strong>Partial COD</strong> option on eligible orders — a hybrid model where you pay a portion online via Razorpay upfront, and the remaining balance in cash at the time of delivery.
              </p>
              <ul className="policy-ul">
            ...
            <div className="policy-section" id="pay-4">
              ...
              <p>Your financial security is our highest priority. Here's what protects you when you pay on Kamali Gifts Factory:</p>
              <ul className="policy-ul">
                ...
                <li><strong>Tokenization:</strong> Razorpay tokenizes saved card data in compliance with RBI's card-on-file tokenization guidelines; actual card numbers are never stored by Kamali Gifts Factory</li>
                ...
                <li><strong>Zero Knowledge Architecture:</strong> Kamali Gifts Factory has zero access to your CVV, UPI PIN, net banking password, or card number at any point</li>
              </ul>
              <div className="policy-highlight">
                <p>Kamali Gifts Factory will <strong>never</strong> ask you for your card number, CVV, OTP, UPI PIN, or net banking credentials via email, phone, or WhatsApp. If you receive such a request claiming to be from Kamali Gifts Factory, it is a phishing attempt — report it to <strong>Kamalireturngifts@gmail.com</strong> immediately.</p>
              </div>
            </div>
            ...
            <div className="policy-section" id="pay-6">
              ...
              <ul className="policy-ul">
                ...
                <li>EMI processing is entirely managed by Razorpay and your issuing bank; Kamali Gifts Factory does not handle EMI approvals or denials</li>
              ...
              <ul className="policy-ul">
                ...
                <li>BNPL credit limits and repayment terms are governed entirely by the respective BNPL provider, not Kamali Gifts Factory</li>
            ...
            <div className="policy-section" id="pay-7">
              ...
              <ul className="policy-ul">
                ...
                <li>Product prices displayed on Kamali Gifts Factory are <strong>inclusive of GST</strong> (Goods and Services Tax) at the applicable rate unless explicitly stated otherwise</li>
            ...
            <div className="policy-section" id="pay-8">
              ...
              <p>All approved refunds are processed through Razorpay back to the original payment source. Refunds are initiated by Kamali Gifts Factory within 24–48 hours of approval; the time to reflect in your account depends on Razorpay's processing and your bank's settlement cycle.</p>
            ...
            <div className="policy-section" id="pay-9">
              ...
              <ul className="policy-ul">
                ...
                <li>For unresolved disputes, Kamali Gifts Factory will respond to all Razorpay-mediated chargeback requests with order evidence including dispatch records, tracking details, and customer communication logs</li>
                <li>Chargeback claims filed for orders that have been validly fulfilled and delivered will be disputed and may result in account suspension on Kamali Gifts Factory</li>
                <li>Razorpay's dispute resolution process and timelines govern the outcome of chargeback proceedings; Kamali Gifts Factory is bound by their decisions</li>
                <li>Customers found to have filed fraudulent chargebacks will be permanently banned from Kamali Gifts Factory and may be reported to Razorpay's risk teams</li>
              </ul>
            </div>
            ...
            <div className="policy-section" id="pay-10">
              ...
              <p>Kamali Gifts Factory takes payment fraud seriously. The following practices protect both our customers and our platform:</p>
              <ul className="policy-ul">
                ...
                <li>Kamali Gifts Factory reserves the right to cancel any order suspected of fraudulent intent, with a full refund issued via Razorpay</li>
              ...
              <div className="policy-warning">
                <strong>Phishing Warning:</strong> Kamali Gifts Factory or Razorpay will <strong>never</strong> send you links to re-enter payment details or request your OTP via SMS, WhatsApp, or email. Do not share OTPs with anyone claiming to be from our support team.
              </div>
            </div>
