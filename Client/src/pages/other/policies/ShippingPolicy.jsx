...
const ShippingPolicy = () => {
  ...
  return (
    <Fragment>
      <SEO
        titleTemplate="Shipping Policy – Kamali Gifts Factory"
        description="Kamali Gifts Factory ships across India. Learn about delivery timelines, shipping charges, tracking, and pre-booking orders for your customized gifts, toys, and stationery."
      />
