...
const ProductSlider = () => {
  ...
  return (
    <Fragment>
      <SEO
        titleTemplate="Shop - Kamali Gifts Factory"
        description="Shop premium personalized gifts and unique handcrafted items at Kamali Gifts Factory. Curated gift solutions for every occasion."
      />
